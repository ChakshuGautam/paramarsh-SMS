...
import { TeacherAttendanceList } from "@/app/admin/resources/teacherAttendance/List";
...
describe("TeacherAttendanceList Component", () => {
  test("renders without errors", async () => {
    const dataProvider = createMockDataProvider(mockData);
    
    renderWithReactAdmin(<TeacherAttendanceList />, {
  ...
  test("has no MUI components", async () => {
    ...
    const { container } = renderWithReactAdmin(<TeacherAttendanceList />, {
      resource: "teacherAttendance",
      dataProvider,
    });
